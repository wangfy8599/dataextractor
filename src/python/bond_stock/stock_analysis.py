...
def generate_report():
    ...
    # df_0 = df_0.query(""" 转债价格 < 130 and 股价 > 3 and 剩余年限 > 1.0 and PB >= 0.99 and 营收同比>-50 and 利润同比>-50 and ROE>2 and 每股现金流>-0.5 """)
    df_0 = df_0.query(""" 转债价格 < 130 and 股价 > 3 and 剩余年限 > 1.0 and PB >= 1 and 利润同比>0 and 每股现金流>-0.5 and ROE>5 """)
